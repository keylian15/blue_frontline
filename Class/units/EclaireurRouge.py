...
class EclaireurRouge(Unit):
    """Classe pour l'unité Éclaireur Rouge."""

    def __init__(self, x, y):
        # Initialiser avec l'image de l'éclaireur rouge
        super().__init__(x, y, RED_ECLAIREUR_IMAGE_PATH, team="red")

        # === Spécifications de l'Éclaireur Rouge ===
        self.cost = 60
        ...
        self.unit_name = "Éclaireur Rouge"
