...
class SousMarinRouge(Unit):
    """Classe pour l'unité Sous-Marin Rouge."""

    def __init__(self, x, y):
        # Initialiser avec l'image du sous-marin rouge
        super().__init__(x, y, RED_SUBMARINE_IMAGE_PATH, team="red")

        # === Spécifications du Sous-Marin Rouge ===
        self.cost = 180
        ...
        self.unit_name = "Sous-Marin Rouge"
    ...
    def update(self, dt=0, combat_system=None, screen=None, camera_offset=(0, 0)):
        """Met à jour le sous-marin rouge."""
