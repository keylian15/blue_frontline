...
class PaquebotVert(Unit):
    """Classe pour l'unité Paquebot Vert."""
    
    def __init__(self, x, y):
        # Initialiser avec l'image du paquebot vert
        super().__init__(x, y, GREEN_PAQUEBOT_IMAGE_PATH, team="green")
        
        # === Spécifications du Paquebot Vert ===
