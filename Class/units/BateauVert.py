...
class BateauVert(Unit):
    """Classe pour l'unité Bateau Vert."""
    
    def __init__(self, x, y):
        # Initialiser avec l'image du bateau vert
        super().__init__(x, y, GREEN_SHIP_IMAGE_PATH, team="green")
        
        # === Spécifications du Bateau Vert ===
