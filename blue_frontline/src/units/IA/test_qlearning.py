...
def test_qlearning_agent():
    ...
    calculated_reward = agent.calculate_reward(mock_chaloupe, test_state, action, next_state)
    ...
    print("✓ Q-table chargée dans nouvel agent")
...
def test_discretization():
    ...
    print("✓ Santé discrétisée correctement")
...
def test_stats_and_monitoring():
    ...
    assert (
        abs(stats["total_rewards"] - expected_total_rewards) < 0.1
    ), f"Récompenses totales incorrectes: {stats['total_rewards']}"
