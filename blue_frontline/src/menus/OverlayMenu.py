...
class OverlayMenu:
    ...
    def __init__(self, screen, game: Game):
        ...
        self.buttons = []
        self.create_button("Destruction", "destruction", "pièce", lambda: self.upgrade("destruction"))
        self.create_button("Dégat", "degat", "% blindage", lambda: self.upgrade("degat"))
        self.create_button("Vitesse", "vitesse", "tirs/4s", lambda: self.upgrade("vitesse"))
    ...
    def position_buttons(self):
        ...
        start_y = (self.height - total_height) // 2 + 50  # Décalé pour le titre
    ...
    def draw(self):
        ...
        pygame.draw.rect(self.screen, (50, 50, 150), title_bg, border_radius=10)
        ...
        # Fond de la croix
        pygame.draw.rect(self.screen, (180, 50, 50), close_button_rect, border_radius=5)
        pygame.draw.rect(self.screen, (255, 255, 255), close_button_rect, width=2, border_radius=5)
        ...
        pygame.draw.line(
            self.screen,
            (255, 255, 255),
            (close_button_rect.left + padding, close_button_rect.top + padding),
            (close_button_rect.right - padding, close_button_rect.bottom - padding),
            3,
        )
        pygame.draw.line(
            self.screen,
            (255, 255, 255),
            (close_button_rect.right - padding, close_button_rect.top + padding),
            (close_button_rect.left + padding, close_button_rect.bottom - padding),
            3,
        )
        ...
        for btn in self.buttons:
            ...
            pygame.draw.rect(self.screen, border_color, btn["rect"], width=2, border_radius=10)
            ...
            for i, line in enumerate(lines):
                ...
                text_rect = text_surface.get_rect(center=(btn["rect"].centerx, y_offset))
