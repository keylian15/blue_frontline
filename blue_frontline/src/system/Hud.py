...
from src.config.paths import (
    GREEN_TEAM_PATH_BIG,
    MAREE_BASSE_IMAGE_PATH,
    MAREE_HAUTE_IMAGE_PATH,
    PETROLE_IMAGE_PATH,
    PIECE_IMAGE_PATH,
    RED_TEAM_PATH_BIG,
)
...
class Hud:
    ...
    def draw(self, screen: pygame.surface):
        ...
        text = font.render(
            str(self.petrole_red.count if self.player_team == "red" else self.petrole_green.count),
            True,
            (0, 0, 0),
        )
        ...
        text = font.render(
            str(self.piece_red.count if self.player_team == "red" else self.piece_green.count),
            True,
            (0, 0, 0),
        )
    ...
    def draw_unit_popup(self):
        ...
        icon_positions = [(self.width * xf, icon_y) for xf in x_factors]
        ...
        for i, key in enumerate(image_keys):
            ...
            mini_rect.midtop = (
                int(icon_x + icon_size / 2 - band_x),
                popup_icon_margin_top,
            )
            ...
            if i == self.popup_selection:
                pygame.draw.rect(band_surface, (255, 215, 0), mini_rect.inflate(8, 8), 2)
