...
from src.config.paths import (
    DEEP_WATER_TILESET_PATH,
    ISLAND_TILESET_PATH,
    MAP_PATH,
    WATER_TILESET_PATH,
)
from src.core.Camera import Camera
from src.menus.OverlayMenu import OverlayMenu
from src.sound.Sound import Sound  # <-- API publique son
...
class GameInitializer:
    ...
    def init_game_systems(self):
        ...
        from src.units.PlateformePetroliere import (
            PlateformePetroliereRouge,
            PlateformePetroliereVerte,
        )
